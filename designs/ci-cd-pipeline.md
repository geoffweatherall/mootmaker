...
| `mootmaker-demo-data` | Same shape as `mootmaker-api` — first time it's included in an automated pipeline, and gains the same tagged Lambda log group treatment (Decision 11). |
