...
31. <a id="uc-31"></a>Rooms exist but none has meetings that day → cards show a "Free all day"/zero-meetings status, not the no-rooms empty state. *(webapp: [E.31](https://github.com/geoffweatherall/mootmaker-webapp/blob/main/acceptance/test-cases/e-room-availability.md#tc-e31) · android: not yet automated)*
32. <a id="uc-32"></a>A room card's expanded meeting list shows subject + time range; clicking a meeting navigates to Meeting Details. *(webapp: [E.32](https://github.com/geoffweatherall/mootmaker-webapp/blob/main/acceptance/test-cases/e-room-availability.md#tc-e32) · android: not yet automated)*
33. <a id="uc-33"></a>Multiple overlapping-in-time meetings across different rooms each show only on their own room's card, without leaking into another room's. *(webapp: [E.33](https://github.com/geoffweatherall/mootmaker-webapp/blob/main/acceptance/test-cases/e-room-availability.md#tc-e33) · android: not yet automated)*
34. <a id="uc-34"></a>Same room, back-to-back meetings (one ending exactly when another starts) both succeed and render as distinct, chronologically-ordered rows in the card's expanded meeting list. *(webapp: [E.34](https://github.com/geoffweatherall/mootmaker-webapp/blob/main/acceptance/test-cases/e-room-availability.md#tc-e34) · android: not yet automated)*
...
36. <a id="uc-36"></a>On a narrow/mobile viewport: room-status cards stack in a single column, with no horizontal scrolling needed. *(webapp: [E.36](https://github.com/geoffweatherall/mootmaker-webapp/blob/main/acceptance/test-cases/e-room-availability.md#tc-e36) · android: not yet automated)*
...
61. <a id="uc-61"></a>The weekly agenda shows only work days (Mon–Fri), one week at a time. *(webapp: [G.61](https://github.com/geoffweatherall/mootmaker-webapp/blob/main/acceptance/test-cases/g-person-calendar.md#tc-g61) · android: not yet automated)*
62. <a id="uc-62"></a>Previous/Next week and This week navigate the visible one-week window, disabled at the server-published booking boundaries. *(webapp: [G.62](https://github.com/geoffweatherall/mootmaker-webapp/blob/main/acceptance/test-cases/g-person-calendar.md#tc-g62) · android: not yet automated)*
...
65. <a id="uc-65"></a>Clicking a meeting row opens its detail panel (bottom sheet on narrow viewports, a side panel at ≥900px), which links through to its Meeting Details page. *(webapp: [G.65](https://github.com/geoffweatherall/mootmaker-webapp/blob/main/acceptance/test-cases/g-person-calendar.md#tc-g65) · android: not yet automated)*
